...
export class ProductDetailComponent implements OnInit {
  ...
  products: Product[] = [
     ...
     { id: 4, name: 'PlayStation 4 Slim', description: 'consola con dos mandos, cable entrada hdmi con 1tb de alamcenamento', price: 1.200 , image: 'https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcTI6X-YDDNKkogGnLDQ0EXmAKJoG_GbzVGp_VUWOSHFiiTYXclwlBzmUNaO16l0xcyLzmknDXMCBGQmcd6btu0yWYMu79gb8q1Y5bBKtGNLm_QV21l4r-J0'},
